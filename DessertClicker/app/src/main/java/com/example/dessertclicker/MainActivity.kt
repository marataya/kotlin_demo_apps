    ...
    Scaffold(
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = {
                ...
                currentDessertImageId = dessertToShow.imgId
...
@Preview
@Composable
fun DessertSoldInfo(dessertsSold: Int = 0, modifier: Modifier = Modifier) {
    Row(
        modifier = modifier,
        horizontalArrangement = Arrangement.SpaceBetween,
    ) {
...
@Preview
@Composable
fun RevenueInfo(revenue: Int = 0, modifier: Modifier = Modifier) {
    Row(
        modifier = modifier,
        horizontalArrangement = Arrangement.SpaceBetween,
    ) {
